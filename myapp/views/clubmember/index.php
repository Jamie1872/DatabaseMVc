...
<a href="/myapp/public/index.php?action=clubmember_create">+ Add New Club Member</a>
<table border="1">
    <thead>
       <tr>
        <th>ID</th>
...
<tbody>
    <?php foreach ($members as $m): ?>
        <tr>
            ...
            <td>
                <a href="/myapp/public/index.php?action=clubmember_edit&id=<?= $m['club_member_id'] ?>">Edit</a> |
                <a href="/myapp/public/index.php?action=clubmember_delete&id=<?= $m['club_member_id'] ?>">Delete</a>
            </td>
        </tr>
    <?php endforeach; ?>
</tbody>
